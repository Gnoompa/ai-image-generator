...
function Images() {
    ...
    return (
     <div>
        ...
        <button 
            className="fixed bottom-10 right-10 bg-green-400/90 text-white px-5 py-3 rounded-md hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-400 font-bold z-20"
        ...
        {isLoading && (
            <p className="animate-pulse text-center pb-7 font-extralight">
                Loading <span className="text-green-400">AI</span> Generated Images...
            </p>
        )}
